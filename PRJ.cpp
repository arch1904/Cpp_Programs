...
\deftab720
\pard\tx450\tx540\tx1080\tx1530\tx1890\pardeftab720\li720\sl276\slmult1\sa200\partightenfactor0
...
#include<iomanip.h>	//for using setw() Function\
...
\
	public:\
		...
		void deposit(int);   		//Function to accept amount and add to \
							Balance of the Account\
		void withdraw(int);		//Function to accept amount and \
							subtract from Balance of the Account\
		void report();		//Function to show data in tabular \
							format\
		int retacno();		//Function to return account number\
		int retdeposit();		//Function to return balance of the \
							Account\
...
\{\
	...
	gets(name);\
	cout<<endl<<"Enter the Contact Number of the Account Holder:"\
			<<endl;\
	gets(no);\
	cout<<endl<<"Enter the Email Address of the Account Holder:"\
			<<endl;\
	gets(email);\
	...
	if(age>=18)\
	\{\
		cout<<endl<<"Eligible to Create an account! Please \
				Proceed!"<<endl;\
		cout<<endl<<"Enter Type of the account (Current(C)/Saving(S)):"\
				<<endl;\
		cin>>type;\
		type=toupper(type);\
		cout<<endl<<"Enter The Initial Amount \\n\
				(More than Rs. 500 for Saving and More than Rs. 1000 for \
				Current) : "<<endl;\
		cin>>balance;\
...
\f0\b\fs24 \cf0 void Account::modify()\
\{\
...
\{\
	cout<<endl<<"==================================="<<endl;\
	cout<<"A/cNo."<<setw(5)<<"Name"<<setw(8)<<"DOB"<<setw(17)\
		<<"Contact No."<<setw(15)\
		<<"EmailAddress"<<setw(17)<<"Type"<<setw(10)\
		<<"Balance";\
	cout<<endl<<"==================================="<<endl;\
	cout<<acno<<setw(9)<<name<<setw(4)<<d<<"/"<<mm<<"/"<<y\
		<<setw(12)<<no<<setw(28)<<email\
...
\{\
	...
	\{\
		...
		cout<<endl<<"\\t 05. DISPLAY LIST OF ALL ACCOUNT \
						HOLDERS"<<endl;\
		...
		\{\
			...
			case 2:\
				...
				break;\
			case 3:\
				cout<<endl<<endl<<"\\t\\t WITHDRAW AMOUNT! \
							\\t\\t"<<endl;\
				cout<<endl<<"\\t Enter the Account No. : "<<endl;\
				cin>>num;\
				...
				break;\
			case 4:\
				cout<<endl<<endl<<"\\t\\t BALANCE ENQUIRY! \
							\\t\\t"<<endl;\
				cout<<endl<<"\\t Enter the Account No. : "<<endl;\
				cin>>num;\
				display_account(num);\
				break;\
			case 5:\
				cout<<endl<<endl<<"\\t\\t LIST OF ALL THE ACCOUNT \
								HOLDERS! \\t\\t"<<endl;\
				display_all();\
				break;\
			case 6:\
				cout<<endl<<endl<<"\\t\\t CLOSE THE ACCOUNT! \
							\\t\\t"<<endl;\
				...
				break;\
			case 7:\
				cout<<endl<<endl<<"\\t\\t MODIFY THE ACCOUNT! \
							\\t\\t"<<endl;\
				cout<<endl<<"\\t Enter the Account No. : ";\
				cin>>num;\
				modify_account(num);\
			...
			case 8:\
				...
				cout<<endl<<"\\t Thanks for using Banking Management \
					System!"<<endl<<"\\t Have a Good Day.:)"<<endl;\
				break;\
\
			default :\
				cout<<"\\a";\
...
\{\
	...
	fin.close();\
	if(flag==0)\
	cout<<endl<<"ERROR!"<<endl<<"Account number does not \
		exist!"<<endl;\
\}\
\
//***************************************************************\
...
\{\
	...
	\{\
		...
		\{\
			...
			if(option==1)\
			\{\
				cout<<endl<<endl<<"\\t\\t DEPOSITE AMOUNT IN THE \
				ACCOUNT! \\t\\t"<<endl;\
			...
			if(option==2)\
			\{\
				cout<<endl<<endl<<"\\t\\t WITHDRAW AMOUNT FROM \
					THE ACCOUNT! \\t\\t"<<endl;\
				...
				if((bal<500 && ac.rettype()=='S') || (bal<1000 && \
					ac.rettype()=='C'))\
				\{\
					cout<<endl<<"Insufficience balance to withdraw \
					from Account"<<endl;\
				\}\
				\
\
...
//***************************************************************\
//    			END OF PROJECT\
\pard\tx450\tx540\tx1080\tx1530\tx1890\pardeftab720\sl276\slmult1\sa200\partightenfactor0
\cf0 //*********************************************************************
\f1\fs22 \cf1 \
\
}