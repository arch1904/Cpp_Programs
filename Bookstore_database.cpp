...
cout<<" delete an account";show2();getchar();return 0;
}
...
page:  system("clear");//change clear to cls for Windows
cout<<"\n Do you want to add a password? (y/n):";reply=getchar();
if(reply=='Y'||reply=='y')
{ system("clear");//change clear to cls for Windows
...
page1:  system("clear");//change clear to cls for Windows
...
for(i='1',x=0;i<='5';i++,x++)
{
page2:  system("clear");//change clear to cls for Windows
if(ch==i)
{
cout<<"\n\n\n\t\t"<<sb.s[x]<<"\n\n\n\n";
for(j=0;j<5;j++)
...
cout<<" 'B' Back";show();ch1=getchar();
for(k='1',y=0;k<='5';k++,y++)
{
if(ch1==k)
{
page3:  system("clear");//change clear to cls for Windows
cout<<"\n\t\t\t\t"<<sb.sub[x][y];
guest.showpb();show();ch2=getchar();
if(ch2=='P'||ch2=='p')
{
if(guest.sbj[x][y]>0)
...
cout<<" 6. "<<"Total\t\t"<<u.totp<<"\t\t"<<u.totr;show2();getchar();
}
int openacc()
{
...
cout<<"'6' Delete your account\n 'B' Back";show();reply=getchar();
if(reply=='1')
{
subject sb;char i,k,ch,ch1,ch2;int x,y,j;
page31:  system("clear");//change clear to cls for Windows
cout<<"\n\n\n\n\n\n\n";
for(x=0;x<5;x++)
{
cout<<" '"<<x+1<<"' "<<sb.s[x]<<"\n";
...
for(i='1',x=0;i<='5';i++,x++)
{
page32:  system("clear");//change clear to cls for Windows
if(ch==i)
{
cout<<"\n\n\n\t\t"<<sb.s[x]<<"\n\n\n\n";
for(j=0;j<5;j++)
...
if(ch1==k)
{
page33:  system("clear");//change clear to cls for Windows
cout<<"\n\t\t\t\t"<<sb.sub[x][y];
u.showpb();cout<<"\n 'R' Return";show();ch2=getchar();
if(ch2=='P'||ch2=='p')
{
if(bklst.sbj[x][y]>0)
{
...
cin.getline(passw,19);strcpy(u.password,passw);
system("clear");//change clear to cls for Windows
cout<<"\n\tPassword modified succesfully!";show2();getchar();
fo.open(name);fo.write((char *) &u,sizeof(u));fo.close();
goto page3;
}
else if(reply=='5')
{ page35:  system("clear");//change clear to cls for Windows
cout<<"\n Remove password?(y/n):";reply=getchar();
if(reply=='Y'||reply=='y')
...
{ page36:  system("clear");//change clear to cls for Windows
cout<<"\n Do you want to delete your account?(y/n):";reply=getchar();
if(reply=='Y'||reply=='y')
{ system("clear");//change clear to cls for Windows
remove(name);
cout<<"\n\tYour account is deleted successfully!";show2();getchar();
namecutter(name);
return 0;
}
else if(reply=='N'||reply=='n'){ goto page3;}
...
{ page3b:  system("clear");//change clear to cls for Windows
